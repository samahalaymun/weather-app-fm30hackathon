  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 mt-[48px] gap-8 w-full  text-white">
      ...
      <div className="lg:col-span-2 flex flex-col gap-8">
        <div className="w-full h-[286px] bg-neutral-800 flex justify-center items-center px-6 py-20 rounded-[20px]">
          <div className="flex flex-col gap-[14px]  justify-center items-center">
            <div className="flex flex-row gap-2.5">
              <div className="w-3 h-3 rounded-full bg-neutral-0"></div>
              <div className="w-3 h-3 rounded-full bg-neutral-0 -translate-y-1"></div>
              <div className="w-3 h-3 rounded-full bg-neutral-0"></div>
            </div>
            <p className="text-lg text-neutral-200 leading-[120%] font-medium">
              Loading...
            </p>
          </div>
        </div>
      ...
      <div className="p-6 bg-neutral-800 flex flex-col gap-4 rounded-[20px] overflow-hidden scroll-auto">
